...
import heroComp from "../assets/heroSection.png";

const Hero = () => {
  return (
    <>
      <div className="bg-[#f5f7fa] p-[20px] sm:p-[40px] lg:px-[60px]">
        <div className="sm:flex sm:justify-between lg:mx-auto xl:w-[1100px]">
          <div className="sm:w-[400px] lg:w-[600px] xl:w-[800px] h-fit my-auto">
            <p className="text-[35px] lg:text-[54px] md:text-[45px] font-[600] text-center sm:text-start text-[#263238]">
          ...
          <div className="hidden sm:block w-[40%] lg:w-[500px]">
            <img className="mx-auto" src={heroComp} alt="" />
          </div>
        </div>
      </div>
    </>
